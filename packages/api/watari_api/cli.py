...
invocation ``watari-api --host ... --port ... --reload`` keeps working.
"""
...
from watari_core.mvs import refresh_price_mvs
from sqlalchemy import select

from watari_api.auth import mint_api_key
...
def build_parser() -> argparse.ArgumentParser:
    ...
    # Top-level serve flags so legacy `watari-api --host ... --port ...`
